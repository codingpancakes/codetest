...
function peg$parse(input, options) {
  ...
  var peg$f5 = function(v, sub) {return {node: "$", sub, var: v}};
  var peg$f6 = function(id, sub) {return {axis: "..", id, sub, recursiveDescent: true}};
  var peg$f7 = function(brackets, sub) {return {axis: "..", brackets, sub, recursiveDescent: true}};
  var peg$f8 = function(sub) {return {axis: ".", wildcard: true, sub}};
  var peg$f9 = function(id, sub) {return {axis: ".", id, sub}};
  var peg$f10 = function(brackets, sub) {return {axis: ".", brackets, sub}};
  var peg$f11 = function(head) { return {head}};
  var peg$f12 = function() { return {wildcard: true}};
  var peg$f13 = function(minus, head, tail) {
  ...
  var peg$f31 = function(func, args) {return {func, args}};
  var peg$f32 = function() {return {
   	head: null,
    tail: [] }
   };
  var peg$f33 = function(head) {return {
   	head,
    tail: [] }
   };
  var peg$f34 = function() { return []};
  var peg$f35 = function(head, tail) {return {
   	head,
    tail: tail.map((t) => t[2]) }
   };
  var peg$f36 = function(start, end) {return {start, end, slice:true}};
  var peg$f37 = function(start) {return {start:start, end:null, slice: true}};
  var peg$f38 = function(end) {return {start:null, end, slice: true}};
  var peg$f39 = function(exp) {return {exp, filter: true}};
  var peg$f40 = function(offset) {return {node:"@", offset: -offset, atmark: true}};
  var peg$f41 = function(op) {return {node: "@", atmark: true}};
  var peg$f42 = function(op) {return {node: "@", atmark: true}};
  var peg$f43 = function(exp) {return {exp}};
  var peg$f44 = function(path, op, minus, val) {return {path, op, val: minus==='-'?-val:val}};
  var peg$f45 = function(v) {return v.join('')};
  var peg$f46 = function(v) {return v.join("")};
  var peg$f47 = function(v) {return v.join("")};
